...
const filter = `*[${productFilter}${generoFilter}${colorFilter}${categoryFilter}${searchFilter}${marcaFilter}${coleccionFilter}${tipoFilter}${razonSocialFilter}${tipoProductoFilter} && empresa == "fritz_sport"  ] `;
  ...
  // 2. Procesar TODOS los productos con productosTraidosSistemaFritzSport
  ...
  if (talla) {
    ...
    allProcessedProducts = await productosTraidosSistemaFritzSport(
      productsRaw,
      "LIMA",
      razonsocial
    );
  ...
  return (
    <Suspense fallback={<LoadingSpinner />}>
      <div key={searchKey}>
        {/* Banner de Tienda (Stock de todos los almacenes) */}
        <div className="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold">Tienda</h1>
                <p className="text-emerald-100 text-sm mt-1">
                  Mostrando stock de todos los almacenes disponibles
                </p>
              </div>
              <div className="hidden md:block">
                <div className="bg-emerald-500 px-4 py-2 rounded-lg">
        ...
        <div>
          <main className="w-full px-6">
            <section aria-labelledby="products-heading" className="pt-6">
              ...
              >
                <div className="block">
                  <ProductFiltersMayorista mayorista={false}/>
                </div>
                <div>
                  <ProductGrid
                    start={start}
