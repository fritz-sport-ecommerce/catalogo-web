const LoadingSpinner = () => (
  ...
  <section className="py-12">
    <div className="text-center">
      <h2 className="text-2xl md:text-3xl font-bold mb-6 uppercase">Descuentos Especiales</h2>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-8">
        {Array(2).fill(0).map((_, index) => (
          <div key={index} className="bg-transparent shadow-md flex flex-col justify-center items-start px-3 animate-pulse md:hidden">
        ...
        {Array(4).fill(0).map((_, index) => (
          <div key={index} className="bg-transparent shadow-md flex flex-col justify-center items-start px-3 animate-pulse hidden md:block">
