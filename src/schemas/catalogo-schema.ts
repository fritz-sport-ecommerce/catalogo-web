...
export const catalogo = defineType({
  ...
  fields: [
    ...
    {
      title: "Imagen Avisos catalogo (png,webp)2480x3505px",
      name: "aviso_catalogo",
      type: "image",
      validation: (rule) => rule.required(),
      options: {
        ...
        {
      title: "Imagen Porta Bench (png,webp)2480x3505px",
      name: "portada_bench",
      type: "image",
    ...
    {
      name: "portadas_catalogo",
      title: "PORTADAS CATALOGO",
      type: "array",
      validation: (rule) => rule.required(),
      of: [
        {
          title: "contenedor_portadas",
          type: "object",
          name: "Contenedor Portadas",
          validation: (rule) => rule.required(),
          fields: [
            {
              title: "Provincia",
            ...
            {
              title: "Image Portada Provincia (png,webp)2480x3505px",
              name: "portada_provincia",
              type: "image",
              validation: (rule) => rule.required(),
              options: {
                hotspot: true, // <-- Defaults to false
    ...
    },
    {
      ...
      of: [
        ...
        {
          hidden: true,
      name: "catalogospdf_emprendedor",
      title: "Lista de Catalogos PDF EMPRENDEDOR",
      type: "array",
      of: [
        {
          title: " PDF",
    ...
    {
      name: "catalogo_campana_genero",
      title: "Portadas Principal Campaña Genero",
      type: "array",
      of: [
        {
          title: "Portada Genero",
          type: "object",
          name: "portada_genero",
          fields: [
            {
            ...
            {
              title: "Imagen Portada Campaña Genero (png,webp)2480x3505px ",
              name: "imagen_campana",
              type: "image",
              validation: (rule) => rule.required(),
            },
