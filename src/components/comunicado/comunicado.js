...
const Modal = ({ ModalHome }) => {
  ...
  const [modalActivoStudio, setModalActivoStudio] = useState(
    ModalHome.activemodal
  );
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          >
            ...
            <Link
              className="w-full"
              href={
                ModalHome.promo.activeurl ? ModalHome.promo?.urlslider : "#"
              }
            >
              <div>
                ...
                <img
                  src={urlForImage(
                    ModalHome?.promo.imgdeskt?.asset?._ref
                  ).url()} // Cambia esta ruta por tu imagen
