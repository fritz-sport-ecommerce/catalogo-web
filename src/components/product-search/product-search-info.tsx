...
export default function ProductInfo({dataProduct,descuento,products,descuentos,descuentoSobreD,outlet}:props) {
  return (
      ...
      >
        <div className='h-5'>
        <CantidadProduct tallas={dataProduct?.tallas} sku={dataProduct?.sku} />
        ...
        {descuento > 0 && 
          ...
          <p className={`${descuento &&
                    products?.preciomanual != products?.priceecommerce || descuentoSobreD ?"text-red-400":"dark:text-white text-black"} font-bold text-base`} >
            S/
            {precioProduct(
              dataProduct.descuento,
