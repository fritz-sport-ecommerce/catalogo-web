...
const Ordercard = (props) => {
    ...
    return (
      <>
        <select
          ...
          value={update.status}
          onChange={(e) => handleIndexChange(e.target.value, "status", i)}
        >
  ...
  const itemsrow = order?.orderinfo?.products.map((item, i) => {
              ...
              <div className="editorder">
                ...
                <div className="innereditorder">
                  ...
                  <Appbtn
                    text="Save"
                    className="saveedit"
                    clickEvent={() => handleUpdates()}
                  />
                </div>
              </div>
              <i
                onClick={() => setEdit(false)}
                className="closeicon fal fa-times"
              ></i>
            </Modal>
          </>
  ...
  return (
    <div className="ordercard">
      ...
      <div className="orderinfo">
        <div className="ordercont">{itemsrow}</div>
        <div className="ordercontrols">{determineControls()}</div>
      </div>
    </div>
  );
};
