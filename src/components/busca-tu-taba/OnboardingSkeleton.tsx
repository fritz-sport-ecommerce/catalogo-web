        ...
        <section className="min-h-[70vh] flex items-start justify-center py-8 lg:py-12">
          <div className="max-w-5xl w-full">
            ...
            <div className="mb-8 lg:mb-12">
              <div className="h-12 sm:h-14 lg:h-16 bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-xl mx-auto w-3/4 mb-4 animate-pulse"></div>
              <div className="h-6 bg-gray-200 dark:bg-gray-700 rounded-lg mx-auto w-1/2 animate-pulse"></div>
            </div>
              ...
              <div className="space-y-4">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
                    ...
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div key={i} className="flex flex-col items-center gap-2 md:gap-3 w-full text-center rounded-xl px-3 py-4 md:py-5 border-2 border-gray-200 dark:border-gray-700">
                        ...
                        <div className="space-y-1 w-full">
                          ...
                          <div className="h-2 bg-gray-200 dark:bg-gray-700 rounded w-12 mx-auto animate-pulse"></div>
                        </div>
                      </div>
                    ))}
                  </div>
                  <div className="mt-4 h-5 bg-gray-200 dark:bg-gray-700 rounded w-64 mx-auto animate-pulse"></div>
                </div>
