        ...
        {Array.from({ length: count }).map((_, i) => (
          <div key={i} className="relative">
            <div className="h-full flex flex-col border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white dark:bg-gray-900">
              {/* Imagen skeleton */}
              <div className="relative overflow-hidden bg-gray-200 dark:bg-gray-800 aspect-square animate-pulse">
              ...
              <div className="flex-1 flex flex-col p-3 space-y-2.5">
                ...
                <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {[1, 2, 3, 4, 5].map((t) => (
                      <div key={t} className="h-5 w-10 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                    ))}
                  </div>
                </div>

                {/* Botón WhatsApp */}
                <div className="h-10 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse mt-2"></div>
              </div>
            </div>
          </div>
        ))}
